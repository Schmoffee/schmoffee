...
import {Platform, Text, View, Keyboard, Alert, StyleSheet} from 'react-native';
...
const Map = (props: MapProps) => {
  ...
  const {track_order_state, track_order_dispatch, location} = useContext(TrackOrderContext);
  /**
  ...
  return (
    <MapView
      ...
      region={
        props.region ? props.region : track_order_state.manually_centered ? track_order_state.map_region : undefined
      }
