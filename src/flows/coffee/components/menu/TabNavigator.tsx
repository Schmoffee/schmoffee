    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.tabContainer}>
                ...
                <TouchableOpacity style={[styles.tab, activeTab === 'coffee' ? styles.activeTab : null]} onPress={() => handleTabPress('coffee')}>
                    <Text style={[styles.tabText, activeTab === 'coffee' ? styles.activeTabText : null]}>Coffee</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.tab, activeTab === 'tea' ? styles.activeTab : null]} onPress={() => handleTabPress('tea')}>
                    <Text style={[styles.tabText, activeTab === 'tea' ? styles.activeTabText : null]}>Tea</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.tab, activeTab === 'bakery' ? styles.activeTab : null]} onPress={() => handleTabPress('bakery')}>
