...
//           if (changes > 0) {
//             ordering_dispatch({type: OrderingActionName.SET_COMMON_BASKET, payload: new_common_basket});
//             // TODO: Alert the user that certain items have been removed from their basket.
//           }
//         }
//         console.log('Synced');
//       }
//       ordering_dispatch({type: OrderingActionName.SET_COMMON_ITEMS, payload: items});
//     });
